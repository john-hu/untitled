...
def main():
    parser = argparse.ArgumentParser(f'Foodnetwork Website peeler, {version}')
    parser.add_argument('--storage', type=str, default=os.path.join('peeler_output', 'foodnetwork'))
    ...
    os.environ['SCRAPY_SETTINGS_MODULE'] = 'peeler.foodnetwork.settings'
    ...
    process.crawl('recipe_list' if args.mode == 'list' else 'recipe_result', domain='foodnetwork.co.uk')
    process.start()
