...
def main():
    parser = argparse.ArgumentParser(f'Yummly Website peeler, {version}')
    parser.add_argument('--storage', type=str, default=os.path.join('peeler_output', 'yummly'))
    ...
    os.environ['SCRAPY_SETTINGS_MODULE'] = 'peeler.yummly.settings'
    ...
    process.crawl('recipe_list' if args.mode == 'list' else 'recipe_result', domain='yummly.co.uk')
    process.start()
