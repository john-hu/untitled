...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'silver_plate.contexts.get_version',
                'silver_plate.contexts.is_debug_mode'
            ],
        },
    },
]
...
PEELER_BASIC_AUTH_USERNAME = os.environ['PEELER_USERNAME']
PEELER_BASIC_AUTH_PASSWORD = os.environ['PEELER_PASSWORD']
