...
class SearchResultView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        search_result = Client(
            settings.CUTTING_BOARD_URL).search_recipe(
            user_query, page_index, PAGE_SIZE, filters)
        # total search pages
        ...
        context['next_index'] = - \
            1 if page_index > pages - 2 else page_index + 1
        ...
        if pages - page_index < 3:
            ...
            # Think about a case pages 7 and at page 6, we will give start
            # index more
